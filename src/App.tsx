...
const CompetitionRegisterPage = lazy(
  () => import('./pages/CompetitionRegisterPage')
);
const CompetitionApplicationPage = lazy(
  () => import('./pages/CompetitionApplicationPage')
);
const CompetitionSchedulePage = lazy(
  () => import('./pages/CompetitionSchedulePage')
);
const CompetitionParticipantsPage = lazy(
  () => import('./pages/CompetitionParticipantsPage')
);
const CompetitionWaitlistPage = lazy(
  () => import('./pages/CompetitionWaitlistPage')
);
                ...
                <Route element={<AppLayout />}>
                  ...
                  <Route
                    ...
                    element={
                      <Suspense
                        fallback={
                          <LoadingState message="대회 정보를 불러오는 중..." />
                        }
                      >
                  ...
                  <Route
                    ...
                    element={
                      <Suspense
                        fallback={
                          <LoadingState message="신청 페이지를 불러오는 중..." />
                        }
                      >
                  ...
                  <Route
                    ...
                    element={
                      <Suspense
                        fallback={
                          <LoadingState message="참가자 명단을 불러오는 중..." />
                        }
                      >
                  ...
                  <Route
                    ...
                    element={
                      <Suspense
                        fallback={
                          <LoadingState message="대기자 명단을 불러오는 중..." />
                        }
                      >
